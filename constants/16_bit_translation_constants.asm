...
DEF MON_TABLE_SAVED_RECENT_INDEXES   EQU  16 ; Increased from 8 to reduce evictions
...
DEF MOVE_TABLE_LOCKED_ENTRIES         EQU  24 ; Increased from 18 for more locked moves
