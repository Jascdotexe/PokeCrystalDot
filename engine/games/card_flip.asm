DEF CARDFLIP_LIGHT_OFF EQU CHARVAL("♂") ; $ef
DEF CARDFLIP_LIGHT_ON  EQU CHARVAL("♀") ; $f5
...
; so this routine relies on the top rows being blank.
	ld de, vTiles0 tile CHARVAL("0")
	ld hl, vTiles0 tile CHARVAL("0") + 2
	ld bc, 10 tiles - 2
	call CopyBytes
	ld hl, vTiles0 tile CHARVAL("9") + 1 tiles - 2
	xor a
	ld [hli], a
	ld [hl], a
	ret
