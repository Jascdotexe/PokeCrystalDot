	...
	const CHERRYGROVEPOKECENTER1F_YOUNGSTER
...
CherrygrovePokecenter1FDigimonScript:
	jumptextfaceplayer CherrygrovePokecenter1FDigimonText
...
CherrygrovePokecenter1FDigimonText:
	text "When I put a"
	line "#MON in the PC,"
...
CherrygrovePokecenter1F_MapEvents:
	...
	object_event  7,  1, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, CherrygrovePokecenter1FDigimonScript, -1
