...
BrunoGroup:
	...
	dw HITMONTOP
	dw BLACKBELT_I
	dw PURSUIT, QUICK_ATTACK, TRIPLE_KICK, DETECT
	db 45
	dw HITMONLEE
	dw BLACKBELT_I
...
KarenGroup:
	...
	dw UMBREON
	dw BLACKGLASSES
	dw DARK_PULSE, CONFUSE_RAY, MOONLIGHT, MEAN_LOOK
	db 46
	dw CRAWDAUNT
	dw QUICK_CLAW
	dw SWORDS_DANCE, CRUNCH, SWIFT, AQUA_JET
	db 46
	dw WEAVILE
	dw FOCUS_BAND
...
JanineGroup:
	...
	dw BEEDRILL
	dw SILVERPOWDER
	dw SWORDS_DANCE, PIN_MISSILE, FURY_CUTTER, POISON_STING
	db 54
	dw NIDOQUEEN
	dw GOLD_BERRY
	dw TAIL_WHIP, CRUNCH, TOXIC, POISON_FANG
	db 56
	dw WEEZING
	dw FOCUS_BAND
	...
	dw CROBAT
	dw QUICK_CLAW
	dw LEECH_LIFE, MEAN_LOOK, CONFUSE_RAY, WING_ATTACK
	db 58
	dw VENOMOTH
	dw POISON_BARB
	dw QUIVER_DANCE, DOUBLE_TEAM, LEECH_LIFE, POISON_FANG
	db -1 ; end
...
SabrinaGroup:
	...
	dw GIRAFARIG
	dw TWISTEDSPOON
	dw AGILITY, NASTY_PLOT, BATON_PASS, PSYBEAM
	db 56
	dw XATU
	dw SHARP_BEAK
	dw AIR_SLASH, PSYCHIC_M, NIGHT_SHADE, DRILL_PECK
	db 58
	dw ESPEON
	dw GOLD_BERRY
	dw FUTURE_SIGHT, CHARM, SWIFT, PSYCHIC_M
	db 56
	dw PORYGONZ
	dw LEFTOVERS
...
BlaineGroup:
	...
	dw HOUNDOOM
	dw GOLD_BERRY
	dw BEAT_UP, FIRE_FANG, THUNDER_FANG, HOWL
	db 56
	dw FLAREON
	dw GOLD_BERRY
	...
	dw RAPIDASH
	dw CHARCOAL
	dw AGILITY, HORN_DRILL, FLAME_CHARGE, INFERNO
	db 58
	dw MAGMORTAR
	dw QUICK_CLAW
...
BlueGroup:
	...
	dw AERODACTYL
	dw SOFT_SAND
	dw AGILITY, SANDSTORM, ROCK_SLIDE, EARTHQUAKE
	db 58
	dw GYARADOS
	dw GOLD_BERRY
	...
	dw UMBREON
	dw LEFTOVERS
	dw TOXIC, MOONLIGHT, DARK_PULSE, MEAN_LOOK
	db -1 ; end
