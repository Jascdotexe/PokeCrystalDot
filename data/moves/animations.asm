...
BattleAnim_IceFang:
	anim_2gfx BATTLE_ANIM_GFX_CUT, BATTLE_ANIM_GFX_ICE
	anim_obj BATTLE_ANIM_OBJ_BITE, 136, 56, $98
	anim_obj BATTLE_ANIM_OBJ_BITE, 136, 56, $18
	anim_wait 8
	anim_sound 0, 1, SFX_BITE
...
BattleAnim_AquaJet:
	anim_2gfx BATTLE_ANIM_GFX_CUT, BATTLE_ANIM_GFX_HIT
	anim_bgeffect BATTLE_BG_EFFECT_START_WATER, $0, BG_EFFECT_TARGET, $0
	anim_bgeffect BATTLE_BG_EFFECT_WATER, $40, $8, $0
	...
	anim_bgeffect BATTLE_BG_EFFECT_WATER, $40, $8, $0
	anim_sound 0, 1, SFX_WATER_GUN
	anim_obj BATTLE_ANIM_OBJ_HYDRO_PUMP, 136, 68, $0
	anim_wait 16
	anim_bgeffect BATTLE_BG_EFFECT_END_WATER, $0, $0, $0
	anim_bgeffect BATTLE_BG_EFFECT_SHOW_MON, $0, BG_EFFECT_USER, $0
	anim_wait 12
...
BattleAnim_Scald:
	anim_2gfx BATTLE_ANIM_GFX_BUBBLE, BATTLE_ANIM_GFX_FIRE
.loop
	anim_sound 16, 2, SFX_BUBBLEBEAM
	anim_obj BATTLE_ANIM_OBJ_BUBBLE, 64, 92, $92
	anim_wait 6
...
BattleAnim_ShadowPunch:
	anim_2gfx BATTLE_ANIM_GFX_HIT, BATTLE_ANIM_GFX_ANGELS
	anim_bgeffect BATTLE_BG_EFFECT_FLASH_INVERTED, $0, $8, $2
	anim_bgeffect BATTLE_BG_EFFECT_HIDE_MON, $0, BG_EFFECT_USER, $0
	anim_bgp $1b
	anim_sound 6, 2, SFX_SCREECH
	anim_obj BATTLE_ANIM_OBJ_DESTINY_BOND, 64, 101, $2
	anim_wait 32
	anim_obj BATTLE_ANIM_OBJ_PUNCH_SHAKE, 132, 46, $10
	anim_bgeffect BATTLE_BG_EFFECT_FLASH_INVERTED, $0, $8, $2
	anim_wait 24
	anim_bgeffect BATTLE_BG_EFFECT_SHOW_MON, $0, BG_EFFECT_USER, $0
	anim_wait 14
...
BattleAnim_WilloWisp:
	...
	anim_sound 6, 2, SFX_EMBER
	anim_call BattleAnim_UserObj_2Row
	anim_obj BATTLE_ANIM_OBJ_FLAME_WHEEL, 52, 104, $12
	anim_wait 8
	anim_obj BATTLE_ANIM_OBJ_FLAME_WHEEL, 50, 98, $14
	anim_wait 8
	anim_obj BATTLE_ANIM_OBJ_FLAME_WHEEL, 48, 89, $13
	anim_call BattleAnim_ShowMon_1
	anim_obj BATTLE_ANIM_OBJ_FLAME_WHEEL, 152, 44, $12
	anim_wait 8
	anim_obj BATTLE_ANIM_OBJ_FLAME_WHEEL, 142, 46, $13
	anim_wait 8
	anim_obj BATTLE_ANIM_OBJ_FLAME_WHEEL, 132, 68, $14
	anim_wait 32
	anim_ret

BattleAnim_ElectroWeb:
	anim_2gfx BATTLE_ANIM_GFX_WEB, BATTLE_ANIM_GFX_LIGHTNING
	anim_bgeffect BATTLE_BG_EFFECT_FLASH_INVERTED, $0, $10, $6
	anim_obj BATTLE_ANIM_OBJ_SPIDER_WEB, 132, 48, $0
	anim_sound 6, 2, SFX_SPIDER_WEB
	anim_wait 4
	anim_sound 0, 1, SFX_THUNDERSHOCK
	anim_obj BATTLE_ANIM_OBJ_THUNDERSHOCK_BALL, 136, 56, $8
	anim_obj BATTLE_ANIM_OBJ_STRING_SHOT, 64, 80, $0
	anim_wait 4
	anim_obj BATTLE_ANIM_OBJ_STRING_SHOT, 64, 84, $0
	anim_wait 64
...
BattleAnim_Moonblast:
	anim_1gfx BATTLE_ANIM_GFX_BEAM, BATTLE_ANIM_GFX_SHINE
	anim_bgeffect BATTLE_BG_EFFECT_CYCLE_MID_OBPALS_GRAY_AND_YELLOW, $0, $0, $0
	anim_bgeffect BATTLE_BG_EFFECT_FLASH_INVERTED, $0, $8, $40
	anim_obj BATTLE_ANIM_OBJ_MOONLIGHT, 0, 40, $0
	anim_wait 2
...
BattleAnim_FairyWind:
	anim_2gfx BATTLE_ANIM_GFX_FLOWER, BATTLE_ANIM_GFX_WIND
	.loop
	anim_sound 0, 0, SFX_MOONLIGHT
...
BattleAnim_DrainPunch:
	...
	anim_sound 0, 1, SFX_COMET_PUNCH
	anim_obj BATTLE_ANIM_OBJ_PUNCH_SHAKE, 122, 46, $43
	anim_sound 0, 1, SFX_WATER_GUN
	anim_call BattleAnimSub_Drain
	anim_wait 128
	anim_wait 48
