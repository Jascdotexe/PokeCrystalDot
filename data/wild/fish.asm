...
; entries correspond to FISHGROUP_* constants
	...
	fishgroup 50 percent + 1, .Garden_Old,           .Garden_Good,           .Garden_Super
...
.Garden_Old:
	dbbw  70 percent + 1, 4, MAGIKARP
	dbbw  85 percent + 1, 4, MAGIKARP
	dbbw 100 percent,     4, POLIWAG
.Garden_Good:
	dbbw  35 percent,     4, MAGIKARP
	dbbw  70 percent,     4, POLIWAG
	dbbw  90 percent + 1, 4, POLIWAG
	dbbw 100 percent,     4, TIME_GROUP
.Garden_Super:
	dbbw  40 percent,     4, POLIWAG
	dbbw  70 percent,     4, TIME_GROUP
	dbbw  90 percent + 1, 4, MAGIKARP
	dbbw 100 percent,     4, POLIWAG
